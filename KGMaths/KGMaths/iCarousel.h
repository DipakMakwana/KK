...
@property (nonatomic, readonly) int numberOfPlaceholders;
@property (nonatomic, assign) int currentItemIndex;
@property (nonatomic, strong, readonly) UIView *currentItemView;
@property (nonatomic, strong, readonly) NSArray *indexesForVisibleItems;
@property (nonatomic, readonly) int numberOfVisibleItems;
...
- (BOOL)carousel:(iCarousel *)carousel shouldSelectItemAtIndex:(int)index;
